...
public class UserFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        AccountMenuAdapter adapter = new AccountMenuAdapter(requireActivity(), accountMenuList, new IItemClickListener() {
            @Override
            public void onClickAccountMenu(AccountMenu accountMenu) {
        ...
        mViewBinding.rvMenuList.addItemDecoration(new DividerItemDecoration(requireActivity(), DividerItemDecoration.VERTICAL));
